/**
 * @Title: CustomizedGlobalRetrievalBolt.java 
 * @Package cn.pku.net.db.storm.ndvr.customized.text 
 * @Description: TODO
 * @author Jiawei Jiang    
 * @date 2015年2月2日 下午1:00:13 
...
/**
 * @ClassName: CustomizedGlobalRetrievalBolt 
 * @Description: TODO
 * @author Jiawei Jiang
 * @date 2015年2月2日 下午1:00:13
 */
public class CustomizedGlobalRetrievalBolt extends BaseBasicBolt {
    ...
    private static final Logger              logger                  = Logger
                                                                         .getLogger(CustomizedGlobalRetrievalBolt.class);
    ...
    public void declareOutputFields(OutputFieldsDeclarer declarer) {
        declarer.declare(new Fields("taskId", "taskType", "queryVideo", "globalSimilarVideoList",
            "startTimeStamp", "fieldGroupingId"));
    }
