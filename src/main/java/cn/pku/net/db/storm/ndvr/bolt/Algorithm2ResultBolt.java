/**
 * @Title: Algorithm2ResultBolt.java 
 * @Package cn.pku.net.db.storm.ndvr.bolt 
 * @Description: TODO
 * @author Jiawei Jiang    
 * @date 2015年1月26日 下午1:46:59 
...
/**
 * @ClassName: Algorithm2ResultBolt
 * @Description: 使用文本信息
 * @author Jiawei Jiang
 * @date 2015年1月26日 下午1:46:59
 */
public class Algorithm2ResultBolt extends BaseBasicBolt {
  ...
  public void execute(Tuple input, BasicOutputCollector collector) {
    ...
    if (Const.STORM_CONFIG.RETRIEVAL_TASK_FLAG.equals(taskType)) {
      ...
      List<TextSimilarVideo> similarVideoList = (new Gson())
