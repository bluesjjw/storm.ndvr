        ...
        if (Const.STORM_CONFIG.RETRIEVAL_TASK_FLAG.equals(taskType)) {
            ...
            for (String comparedVideoId : comparedVideoIdSet) {
                ...
                if ((queryVScompared == 0) || (comparedVSquery == 0)) {
                    ...
                    harmonicSimilarity = queryVScompared * comparedVSquery / (queryVScompared + comparedVSquery);
                }
            ...
            if (Const.SSM_CONFIG.IS_REDUCTIION) {
                ctrlMsg = Const.SSM_CONFIG.discardInvalidKey("TextSimilarityBolt", ctrlMsg);
            }
            ...
            logger.info("Control message size in text similarity: " + msgLength + ", taskId: " + taskId);
        }
