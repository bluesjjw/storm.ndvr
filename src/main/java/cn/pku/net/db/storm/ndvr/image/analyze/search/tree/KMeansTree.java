...
public class KMeansTree implements VocabularyTree, Serializable {
     ...
     */
    public KMeansTree(List<Clusterable> items, int branchFactor, int height,
                      ClusterBuilder clusterer) {
        this.branchFactor = branchFactor;
        maxHeight = height;
        rootNode = new KMeansTreeNode(Cluster.getMeanValue(items), items, this.branchFactor,
            maxHeight, 0, clusterer);
    }
