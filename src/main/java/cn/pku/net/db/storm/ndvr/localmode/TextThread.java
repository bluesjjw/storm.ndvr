/**
 * @Title: NdvrThread.java 
 * @Package cn.pku.net.db.storm.ndvr.localmode 
 * @Description: TODO
 * @author Jiawei Jiang    
 * @date 2015年1月26日 上午9:46:15 
...
public class TextThread implements Runnable {
    ...
    private static final Logger logger = Logger.getLogger(TextThread.class);
    private TaskEntity          task   = new TaskEntity();

    /**
     * @param taskEnt
     */
    public TextThread(TaskEntity taskEnt) {
        super();
        this.task = taskEnt;
    }
