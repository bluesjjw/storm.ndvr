 ...
 */
public class LocalFeatureBolt extends BaseBasicBolt {
    private static final Logger logger = Logger.getLogger(LocalFeatureBolt.class);
    ...
    public void execute(Tuple input, BasicOutputCollector collector) {
        ...
        if (Const.STORM_CONFIG.RETRIEVAL_TASK_FLAG.equals(taskType)) {
            ...
            if (Const.SSM_CONFIG.IS_REDUCTIION) {
                ctrlMsg = Const.SSM_CONFIG.discardInvalidKey("LocalFeatureBolt", ctrlMsg);
            }
            ...
            logger.info("Control message size in local feature: " + msgLength + ", taskId: " + taskId);
