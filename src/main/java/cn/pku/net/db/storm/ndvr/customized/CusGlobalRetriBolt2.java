...
/**
 * Description: Customized bolt for retrieval task, compare global visual signature
 *
 * @author jeremyjiang
...
public class CusGlobalRetriBolt2 extends BaseBasicBolt {
    ...
    public void execute(Tuple input, BasicOutputCollector collector) {
        ...
        if ((null == queryVideoHsvSig) || (null == queryVideoHsvSig.getSig())) {
            ...
            // bolt输出
            collector.emit(new Values(taskId, taskType, globalSimilarVideoList, startTimeStamp, fieldGroupingId));
        ...
        collector.emit(new Values(taskId, taskType, globalSimVideoListStr, startTimeStamp, fieldGroupingId));
    }
}
