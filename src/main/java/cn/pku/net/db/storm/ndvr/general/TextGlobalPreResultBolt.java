...
/**
 * Description: Use textual and global visual feature, filter-and-refine strategy
 *
 * @author jeremyjiang
 * Created at 2016/5/13 9:50
 */
public class TextGlobalPreResultBolt extends BaseBasicBolt {

    private static final Logger logger                = Logger.getLogger(TextGlobalPreResultBolt.class);
