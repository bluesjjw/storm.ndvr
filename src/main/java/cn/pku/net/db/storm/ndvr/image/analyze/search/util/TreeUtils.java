package cn.pku.net.db.storm.ndvr.image.analyze.search.util;

import java.util.LinkedList;
import java.util.List;

import cn.pku.net.db.storm.ndvr.image.analyze.search.cluster.Clusterable;
import cn.pku.net.db.storm.ndvr.image.analyze.search.tree.KMeansTreeNode;
...
public class TreeUtils {
    ...
    public static List<Float> getCurrentWord(KMeansTreeNode node, int totalNodeCount) {
        ...
        float weight = (float) Math.log((float) node.getNumSubItems() / totalNodeCount);
