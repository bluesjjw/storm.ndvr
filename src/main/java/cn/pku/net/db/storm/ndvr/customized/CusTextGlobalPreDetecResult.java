...
/**
 * Description: Customized result bolt for post-filtering retrieval task, save the textual and global similar video list to MongoDB

 *
 * @author jeremyjiang
 *         Created at 2016/6/16 18:14
 */

public class CusTextGlobalPreDetecResult extends BaseBasicBolt {
    private static final Logger logger                = Logger.getLogger(CusTextGlobalPreDetecResult.class);
