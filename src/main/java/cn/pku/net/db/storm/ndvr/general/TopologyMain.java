...
public class TopologyMain {
    ...
    public static void main(String[] args) {
        ...
        // builder.setBolt("textSimilarity", new TextSimilarityBolt(), 100).fieldsGrouping(
        ...
        builder.setBolt("result", new TextGlobalPreResultBolt(), 20).shuffleGrouping("localDistance");
