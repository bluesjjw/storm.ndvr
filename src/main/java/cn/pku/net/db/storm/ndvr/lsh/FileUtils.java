...
/**
 * Description: An utility class for file interaction.
 *
 * @author jeremyjiang
 * Created at 2016/6/17 11:42
 */
...
public class FileUtils {
    ...
    public static String temporaryDirectory() {
        ...
        if (tempDir.contains(" ")) {
            LOG.error("Temporary directory (" + tempDir + ") contains whitespace");
        }
        return tempDir;
    }
    ...
    public static String runtimeDirectory() {
        ...
        try {
            ...
            LOG.error("Could not find runtime path, strange.", e);
        }
        return runtimePath;
    }
    ...
    private static void writeFile(final String contents, final String name, final boolean append) {
        ...
        try {
            ...
            LOG.error("Could not write file " + name, e);
        } finally {
            try {
    ...
    public static String readFile(final String name) {
        ...
        try {
            ...
            LOG.error("Can't open file:" + name);
        }
    ...
    public static String readFileFromJar(final String path) {
        ...
        try {
            ...
            LOG.error("Error while reading file " + path + " from jar: " + e.getMessage());
    ...
    public static void copyFileFromJar(final String source, final String target) {
        try {
            ...
            LOG.error("Exception while copying file from jar" + e.getMessage(), e);
        }
    }
    ...
    public static void cp(final String source, final String target) {
        ...
        try {
            ...
            LOG.error("File " + source + " not found! " + e.getMessage());
        } catch (final IOException e) {
            LOG.error("Error while copying " + source + " to " + target + " : " + e.getMessage());
        } finally {
            try {
                if (inChannel != null) {
                    inChannel.close();
                ...
                // ignore
                LOG.error("Ignored exception while copying files", e);
            }
        }
    }
