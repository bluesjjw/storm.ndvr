...
/**
 * Description: Customized result bolt for retrieval task, save textual similar video list to MongoDB
 *
 * @author jeremyjiang
 * Created at 2016/5/12 20:52
 */
public class CusTextRetriResult extends BaseBasicBolt {
