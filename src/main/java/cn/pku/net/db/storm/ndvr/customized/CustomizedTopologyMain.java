...
public class CustomizedTopologyMain {
    ...
    public static void main(String[] args) {
        ...
        // "getTask");
        builder.setBolt("similarity", new CustomizedTextDetectionBolt(), 400).shuffleGrouping("getTask");
        builder.setBolt("result", new CustomizedTextDetectionResult(), 100)
               .fieldsGrouping("similarity", new Fields("taskId"));
        ...
        if (Const.STORM_CONFIG.IS_LOCAL_MODE) {    // 如果是本地模式
            ...
            try {
                StormSubmitter.submitTopology("customizedRetrieval", conf, builder.createTopology());
